...
constexpr std::array<OpcodeInfo, 256> make_opcode_table() {
    ...
    t[0xA0] = {.op = mov,
               ...
               .has_modrm = false,
               .w_mask = 0x01,
               .clock_kind = ClockKind::mov}; // mov al, [addr]
    t[0xA1] = {.op = mov,
               .dst = OpSource::acc,
               .src = OpSource::addr,
               .has_modrm = false,
               .w_mask = 0x01,
               .clock_kind = ClockKind::mov}; // mov ax, [addr]
    t[0xA2] = {.op = mov,
               .dst = OpSource::addr,
               .src = OpSource::acc,
               .has_modrm = false,
               .w_mask = 0x01,
               .clock_kind = ClockKind::mov}; // mov [addr], al
    t[0xA3] = {.op = mov,
               .dst = OpSource::addr,
               .src = OpSource::acc,
               .has_modrm = false,
               .w_mask = 0x01,
               .clock_kind = ClockKind::mov}; // mov [addr], ax
    ...
    t[0x70] = {.op = jo,
               ...
               .has_modrm = false,
               .w_mask = 0x00,
               .clock_kind = ClockKind::conditional_jump};
    t[0x71] = {.op = jno,
               .dst = OpSource::rel8,
               .src = OpSource::none,
               .has_modrm = false,
    ...
    t[0xE0] = {.op = loopnz,
               ...
               .has_modrm = false,
               .w_mask = 0x00,
               .clock_kind = ClockKind::loop_jump};
    t[0xE1] = {.op = loopz,
               .dst = OpSource::rel8,
               .src = OpSource::none,
               .has_modrm = false,
